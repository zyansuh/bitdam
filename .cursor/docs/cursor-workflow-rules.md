...
> 커밋은 Granular. 브랜치·PR 기본값은 **잘게 나눈 스택**입니다 (`.cursor/rules/pr-split.mdc`).
> 기능이 둘 이상이면 브랜치를 관심사별로 **자동으로** 나눕니다. 사용자에게 브랜치 생성을 묻지 않습니다. 사용자가 PR을 요청하면 스택을 푸시하고 PR을 엽니다. force push는 하지 않습니다.
