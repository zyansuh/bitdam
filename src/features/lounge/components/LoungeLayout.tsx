...
import { needsWorkshopVerify } from '../../../shared/utils/workspaceRole'
...
import LoungeVerifyModal from './LoungeVerifyModal'
      ...
      <main className="lounge-page">
        {!access.isLoggedIn ? (
          ...
          <section className="lounge-denied">
            ...
            <p>일반 회원은 마이페이지에서 주문·배송만 확인할 수 있습니다. 공방을 운영하면 사업자 인증 후 셀러 라운지를 열 수 있습니다.</p>
            <Link to="/mypage/lounge/verify" className="lounge-denied__link">
              입점 사업자 인증
            </Link>
          </section>
        ) : needsWorkshopVerify(access.user) ? (
          <LoungeVerifyModal />
        ) : (
          <LoungeScopeProvider>
